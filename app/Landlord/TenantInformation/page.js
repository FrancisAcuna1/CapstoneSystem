...
const ListofTenantComponent = dynamic(() => import('../ComponentLayout/HeroContent/TenantInformationComponent'), {
  ssr: false
  }) 
  ...
  return (
    <>
      ...
      <Box sx={{ display: 'flex', minHeight: '100vh' }}>
          ...
          {loading && <LinearProgress sx={{ color:"#673ab7", position: 'fixed',  zIndex: 2100, top: 0, left: 0, right: 0, height: 4, borderRadius: '4px 4px 0 0' }} />}
          <Box component="main" sx={{ flex: 1, py: 2, px: 3, bgcolor: '#eaeff1' }}>
              <ListofTenantComponent
                loading={loading}
