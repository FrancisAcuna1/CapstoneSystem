...
import PaymentHistoryTable from '../PaymentHistory/page';
const PaymentHistory = dynamic(() => import('../PaymentHistory/page'), {
ssr: false
}) 
        ...
        <Box sx={{ maxWidth: 1400,  margin: 'auto', }}>
            ...
            <Grid  container spacing={1}>
                <Grid item xs={12} md={5} lg={5}>
                    <Paper elevation={1} style={{width: {xs: 300, lg: 'auto'}, padding: '25px', marginTop: '15px', borderRadius: '15px'}}>  
            ...
            <Grid  container spacing={2} >
                <Grid item xs={12} md={5} lg={7}>
                    <Paper elevation={2} style={{height: {xs:'20vh', lg:'20vh'}, marginTop: '15px',  borderRadius: '15px' ,  padding: "1rem 0rem 0rem 0rem",  }}>  
                ...
                <Grid item xs={12} md={5} lg={5}>
                    <Paper elevation={3} sx={{ height: {xs:'65vh', lg:'51vh'}, padding: '25px', marginTop: '15px',  borderRadius: '15px'}}>  
                        <Grid container justifyContent="start" sx={{ mb: 1, mt:3 }}>
                            <Box>
                            <Typography variant="h5" color={'gray'} sx={{fontSize: {xs: '21px', sm: '24px', md: '22px', lg: '24px'}, marginTop: '0.6rem', mb: 2 }} letterSpacing={2} gutterBottom>
                              Rental Fee
                            </Typography>
                            </Box>
                            ...
                            <Grid item xs='12' >
                                <Box  bgcolor={'#eeeeee'} display='flex' alignItems='center' mt={'-0.9rem'}> 
                                    <Grid container justifyContent='space-between'>
                                        <Grid item>
                                            <Typography variant="body1" color={'black'} sx={{ fontSize: {xs: '15px', sm: '24px', md: '15px', lg: '18px'},  ml: '1.2rem', mt: 1,  }} letterSpacing={2} gutterBottom>
                                            Total Amount:
                                            </Typography>
                                        </Grid>
                                        <Grid item>
                                            <Typography variant="body1" color={'black'} sx={{ fontSize: {xs: '15px', sm: '24px', md: '15px', lg: '18px'}, mr: 1,  mt: 1,  }} letterSpacing={2} gutterBottom>
                                            ₱100,000.00
                                            </Typography>
                                        </Grid>
                                    </Grid>
                            ...
                            <Grid item xs='12' >
                                <Box  bgcolor={'#eeeeee'} display='flex' alignItems='center' mt={'-0.9rem'}> 
                                    <Grid container justifyContent='space-between'>
                                        ...
                                        <Grid item>
                                            <Typography variant="body1" color={'#2e7d32'} sx={{ fontSize: {xs: '15px', sm: '24px', md: '15px', lg: '18px'}, mr: 1,  mt: 1,  }} letterSpacing={2} gutterBottom>
                                            ₱2,500.00
                                            </Typography>
                                        </Grid>
                                    </Grid>
                            ...
                            <Grid item xs='12' >
                                <Box  bgcolor={'#eeeeee'} display='flex' alignItems='center' mt={'-0.9rem'}> 
                                    <Grid container justifyContent='space-between'>
                                        ...
                                        <Grid item>
                                            <Typography variant="body1" color={'#c62828'} sx={{fontSize: {xs: '15px', sm: '24px', md: '15px', lg: '18px'}, mr: 1,  mt: 1,  }} letterSpacing={2} gutterBottom>
                                            ₱75,000.00
                                            </Typography>
                                        </Grid>
                                    </Grid>
