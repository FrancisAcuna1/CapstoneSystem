...
export default function WarningActiveTenant({ open, setOpen }) {
    ...
    >
      ...
      >
        ...
        >
          ...
          The deletion process could not be completed due to the following issues:
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
           • The selected tenant is currently occupied or has an active status.
        </Typography>
      </DialogContent>
