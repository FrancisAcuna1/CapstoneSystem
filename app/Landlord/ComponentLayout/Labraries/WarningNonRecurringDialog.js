...
export default function WarningNonRecurring({ open, setWarningOpen1 }) {
  const theme = useTheme();
  const handleClose = () => {
    setWarningOpen1(false);
  }
  return (
    <React.Fragment>
    <Dialog
    ...
    >
      ...
      >
        ...
        The process has not been continued due to these warnings:
        </Typography>
        <Typography
          variant="body1"
          sx={{
        ...
        >
          • The record you checked is not recurring
        </Typography>
      </DialogContent>
