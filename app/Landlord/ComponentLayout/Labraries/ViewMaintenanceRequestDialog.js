            ...
            <Box sx={{ py: 3, px: 2 }}>
                ...
                >
                  <Box>
                    ...
                    >
                      ...
                      <Typography variant="body2" color="text.secondary">
                        {unitAddress[0]?.rented_unit?.street}{" "}
                        {unitAddress[0]?.rented_unit?.barangay}{" "}
                        {unitAddress[0]?.rented_unit?.municipality}
                      </Typography>
                    </Box>
                  </Box>
              ...
              <Box sx={{ mt: 4, "& > *": { mb: 3 } }}>
                <Box>
                  ...
                  <Paper
                    elevation={0}
                    sx={{ p: 2.5, backgroundColor: "grey.50" }}
                  >
                    <Typography>
