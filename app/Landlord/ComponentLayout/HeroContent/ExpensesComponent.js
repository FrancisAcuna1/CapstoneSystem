...
import { Grid, Box, Paper, Typography,  Link, Breadcrumbs, InputLabel, FormControl, FormControlLabel, Select, MenuItem, Button, Tabs, Tab} from '@mui/material';
        ...
        <Box sx={{ maxWidth: 1400,  margin: 'auto', }}>
            ...
            <Grid item xs={12} sx={{marginLeft: '5px', mt:2}}>
                <Breadcrumbs aria-label="breadcrumb"  sx={{ fontSize: { xs: '14px', sm: '15px', md: '15px' } }}>
                    ...
                    <Typography letterSpacing={2} color="text.primary"  sx={{ fontSize: { xs: '14px', sm: '15px', md: '15px' } }}>Expenses Tracking</Typography>
                </Breadcrumbs>
            </Grid>
            <Box sx={{mt:'4rem'}}>
            </Box>
            ...
            <Grid  container spacing={1} sx={{ mt: '-0.9rem', display:'flex', justifyContent:' center',  }}>
                ...
                <Grid item xs={12} sx={{mt:4}}>
                    <Paper elevation={2} sx={{maxWidth: {xs: 800, md: 940, lg: 1400},  height: { xs: '50vh', lg: '64vh' },  padding: "1.8rem 1rem 4rem 1rem", borderRadius: "10px",  justifyContent: 'center', alignItems: 'center', }}>
