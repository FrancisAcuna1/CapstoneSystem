...
const features = [
  {
    ...
    description:
      "Find apartments or boarding houses efficiently with our advanced search tools.",
    icon: <SearchIcon fontSize="large" color="primary" />,
  },
  {
    title: "Tenant & Landlord Communication",
    description:
      "Tools like chat, maintenance requests, and messaging to keep communication open.",
    icon: <ForumIcon fontSize="large" color="primary" />,
  },
  {
    title: "Property Management Tools",
    description:
      "Features for landlords, such as payment tracking and lease management, to streamline property management.",
                ...
                <Grid item xs={12} sm={6} md={4} key={index}>
                  ...
                  >
                    ...
                    <Typography
                      variant="h6"
                      gutterBottom
                      sx={{ mt: 2, fontSize: { xs: "1.25rem", sm: "1.5rem" } }}
                    >
                      {feature.title}
                    </Typography>
                    <Typography
